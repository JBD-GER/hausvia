    ...
    <main className="overflow-hidden bg-white">
      ...
      <section className="relative isolate overflow-hidden bg-slate-950 text-white">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 10% 20%, rgba(34,211,238,0.28), transparent 30%), radial-gradient(circle at 92% 82%, rgba(14,165,233,0.2), transparent 34%)",
          }}
        />
        <div className="absolute -left-16 top-24 -z-10 h-64 w-64 rounded-full border border-cyan-300/10" aria-hidden="true" />
        <div className="absolute -right-24 -top-28 -z-10 h-96 w-96 rounded-full border border-sky-300/10" aria-hidden="true" />

        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-14 sm:px-6 sm:py-18 lg:grid-cols-[1.02fr_0.98fr] lg:px-8 lg:py-20">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                ...
                className="inline-flex min-h-14 items-center justify-center gap-2 rounded-xl bg-cyan-300 px-6 py-3.5 text-base font-extrabold text-sky-950 shadow-lg shadow-cyan-950/30 transition hover:bg-cyan-200 focus:outline-none focus:ring-2 focus:ring-cyan-200 focus:ring-offset-2 focus:ring-offset-slate-950"
              >
                Preis berechnen
            ...
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-3 text-sm font-bold text-sky-100">
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-950 via-slate-950/80 to-transparent px-5 pb-5 pt-20 sm:px-6 sm:pb-6">
                <div className="grid grid-cols-2 gap-3">
                  <div className="rounded-xl border border-white/15 bg-white/10 p-4 backdrop-blur-md">
                    <p className="text-xs font-bold uppercase tracking-wide text-cyan-200">Feste Saison</p>
                    <p className="mt-1 text-lg font-extrabold">01.11.–31.03.</p>
                  </div>
                  <div className="rounded-xl border border-white/15 bg-white/10 p-4 backdrop-blur-md">
                    <p className="text-xs font-bold uppercase tracking-wide text-cyan-200">Abrechnung</p>
                    <p className="mt-1 text-lg font-extrabold">Nur echte Einsätze</p>
                  </div>
                </div>
              </div>
            </div>
            <span className="absolute -right-4 -top-4 grid h-14 w-14 place-items-center rounded-2xl bg-cyan-300 text-sky-950 shadow-xl sm:-right-6 sm:-top-6 sm:h-16 sm:w-16">
      ...
      <section className="border-b border-slate-200 bg-sky-50">
        <div className="mx-auto grid max-w-7xl gap-3 px-4 py-5 sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:px-8">
          {trustItems.map((item) => {
            ...
            return (
              <div key={item.text} className="flex items-center gap-3 rounded-xl border border-sky-200 bg-white px-4 py-3.5 shadow-sm">
                <span className="grid h-9 w-9 flex-none place-items-center rounded-lg bg-cyan-100 text-cyan-800">
      ...
      <section className="bg-gradient-to-b from-white to-sky-50 px-4 py-14 sm:px-6 sm:py-18 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 max-w-3xl">
            <p className="text-sm font-extrabold uppercase tracking-[0.16em] text-cyan-700">Direkte Preiseinschätzung</p>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-2">
            <article className="relative overflow-hidden rounded-2xl border border-sky-200 bg-sky-50 p-6 sm:p-8">
              <span className="grid h-12 w-12 place-items-center rounded-xl bg-sky-950 text-cyan-200">
                <CalendarRange aria-hidden="true" className="h-6 w-6" />
              </span>
              <p className="mt-6 text-xs font-extrabold uppercase tracking-[0.16em] text-cyan-800">01. November bis 31. März</p>
            ...
            <article className="relative overflow-hidden rounded-2xl border border-cyan-400 bg-gradient-to-br from-cyan-600 to-sky-800 p-6 text-white shadow-xl shadow-cyan-950/10 sm:p-8">
              ...
              <p className="mt-6 text-xs font-extrabold uppercase tracking-[0.16em] text-cyan-100">Wetterabhängig und nachvollziehbar</p>
          ...
          <div className="mt-6 flex flex-col gap-5 rounded-2xl border border-slate-200 bg-slate-50 p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8">
            ...
            <Link
              href="#winterdienst-preis"
              className="inline-flex min-h-12 flex-none items-center justify-center gap-2 rounded-xl bg-slate-950 px-5 py-3 text-sm font-extrabold text-white transition hover:bg-sky-950"
            >
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {services.map((service) => (
              <article key={service.title} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm shadow-slate-950/5">
                <span className="grid h-10 w-10 place-items-center rounded-xl bg-cyan-100 text-cyan-800">
          ...
          <div className="mt-8 grid overflow-hidden rounded-2xl border border-slate-200 bg-white lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className="p-6 sm:p-8 lg:p-10">
              <p className="text-sm font-extrabold uppercase tracking-[0.16em] text-cyan-700">Klare Leistungsgrenzen</p>
      ...
      <section className="bg-slate-950 text-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="max-w-3xl">
            <p className="text-sm font-extrabold uppercase tracking-[0.16em] text-cyan-300">Einfacher Start</p>
          ...
          <ol className="mt-10 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {process.map((step, index) => (
              <li key={step.title} className="relative rounded-2xl border border-white/10 bg-white/5 p-6">
                <span className="grid h-10 w-10 place-items-center rounded-xl bg-cyan-300 text-sm font-extrabold text-sky-950">
                  {index + 1}
                </span>
      ...
      <section className="bg-white">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-center lg:px-8 lg:py-20">
          <div className="rounded-2xl border border-sky-200 bg-sky-50 p-6 sm:p-8">
            ...
            <p className="mt-6 text-sm font-extrabold uppercase tracking-[0.16em] text-cyan-800">Lokale Einsatzplanung</p>
          ...
          <div>
            ...
            <div className="mt-7 flex gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <ShieldCheck aria-hidden="true" className="mt-0.5 h-6 w-6 flex-none text-cyan-700" />
              <div>
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-4 inline-flex items-center gap-2 text-sm font-extrabold text-cyan-800 underline decoration-cyan-300 underline-offset-4 hover:text-cyan-950"
                >
      ...
      <section className="bg-gradient-to-br from-cyan-600 via-sky-700 to-sky-950 text-white">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_auto] lg:items-center lg:px-8 lg:py-14">
          ...
          <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
            <Link
              href="#winterdienst-preis"
              className="inline-flex min-h-13 items-center justify-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-extrabold text-sky-950 transition hover:bg-cyan-50"
            >
